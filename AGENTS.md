...
- Generated records are stored under `ANALYSIS_STORAGE_DIR`, defaulting to `storage/`. Do not commit generated images, uploaded photos, metadata, or other user data.
